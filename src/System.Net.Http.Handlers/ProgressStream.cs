...
/// </summary>
internal sealed class ProgressStream : DelegatingStream
{
    ...
    public ProgressStream(Stream innerStream, ProgressMessageHandler handler, HttpRequestMessage request, HttpResponseMessage? response = null)
        : base(innerStream)
    {
    ...
    public override async Task<int> ReadAsync(byte[] buffer, int offset, int count, CancellationToken cancellationToken)
    {
        ...
        var readCount = await InnerStream.ReadAsync(buffer.AsMemory(offset, count), cancellationToken);
#else
