...
internal static class Error
{
    ...
    {
        return new ArgumentException(Error.Format(Net.Http.Handlers.Properties.Resources.ArgumentInvalidHttpUriScheme, actualValue, HttpScheme, HttpsScheme), parameterName);
    }
    ...
    {
        return new ArgumentException(Error.Format(Net.Http.Handlers.Properties.Resources.ArgumentInvalidAbsoluteUri, actualValue), parameterName);
    }
    ...
    {
        return new ArgumentException(Error.Format(Net.Http.Handlers.Properties.Resources.ArgumentUriHasQueryOrFragment, actualValue), parameterName);
    }
    ...
    {
        return Error.Argument(parameterName, Net.Http.Handlers.Properties.Resources.ArgumentNullOrEmpty, parameterName);
    }
    ...
    {
        return new ArgumentOutOfRangeException(parameterName, actualValue, Error.Format(Net.Http.Handlers.Properties.Resources.ArgumentMustBeGreaterThanOrEqualTo, minValue));
    }
    ...
    {
        return new ArgumentOutOfRangeException(parameterName, actualValue, Error.Format(Net.Http.Handlers.Properties.Resources.ArgumentMustBeLessThanOrEqualTo, maxValue));
    }
